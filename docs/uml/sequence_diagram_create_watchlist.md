...
This diagram shows the process of creating a new watchlist with customizable event type settings. The system generates a unique calendar token, inserts the watchlist and its settings into the database, and returns the created watchlist.
