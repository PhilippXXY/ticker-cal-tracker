...
class StockSchema(Schema):
    ...
    Schema for a stock.
    '''
    isin = fields.Str(required=True, validate=Length(equal=12), metadata={"description": "International Securities Identification Number. Canonical unique identifier (12 chars)", "pattern": "^[A-Z]{2}[A-Z0-9]{10}$", "unique": True, "example": "US0378331005"})
